...
<%
			...
			try{			
				 ...
				 if(cookies!=null)
				 {
				 	...
				 	{
				 		cookie=cookies[i];
				 		if(cookie.getName().equals("IDNumber"))
				 		{
				 			IDNumber =new String(URLDecoder.decode(cookie.getValue()).getBytes("iso-8859-1"),"utf-8");				          	
				 		}
  ...
  <div class="panel-body">   
		<form action="clientLogin" method="post">
			<div class="input-group  animated bounceInDown">
		        ...
		        <input type="text" class="form-control input-lg" name="IDNumber" placeholder="身份证号" value=<% out.print(IDNumber); %>>		       
     		</div>
			...
			<div class="animated bounceInUp">
				<input class="btn btn-block btn-primary input-lg" type="button" value="登录"  onclick="clSubmit(this)">
			</div>
			<div style="color:red;height:20px " id="error"></div>
			<div class="animated bounceInUp">
				<a class="a_register" href="register.jsp">
					还没注册？点击这里注册！
				</a>
			</div>
		</form>	
